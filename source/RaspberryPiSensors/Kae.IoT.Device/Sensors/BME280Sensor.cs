...
{
    public class BME280Sensor : ISensor, IDisposable
    {
        ...
        int busId;
        I2cDevice i2cDevice;
        CariblationData calibrationData = new CariblationData();
        ...
        {
            ReadSensors();
            return new List<(SensorType, double)>() { (SensorType.Temperature, temperature), (SensorType.Pressure, pressure), (SensorType.Humidity, humidity) };
        }
